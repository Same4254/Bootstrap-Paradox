...
FUNC TRANSLATE_TOKEN ( ptr )
    ...
    DUP TOKEN_ELSE = IF
        ...
        ( don't let the IF fall through to the ELSE )
        DUP
        JMP " then_" F_WRITE
    ...
    DUP TOKEN_STORE = IF
        ...
        MOV SPACE LSQ _RBX RSQ COM SPACE _RAX F_NEWLINE
    ...
    DUP TOKEN_STORE_BYTE = IF
        DROP DROP

        "; ptr store byte" F_WRITELN
        "rax" POP_REG
        "rbx" POP_REG

        MOV " byte " F_WRITE LSQ _RBX RSQ COM SPACE _AL F_NEWLINE
